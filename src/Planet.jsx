      ...
      <nav>
        ...
        <div className={props.active ? "mobile_planets" : "Disable"}>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/venus" className="mobile_planets_name spartan">
              venus
            </Link>
          </div>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/earth" className="mobile_planets_name spartan">
              earth
            </Link>
          </div>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/mars" className="mobile_planets_name spartan">
              mars
            </Link>
          </div>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/jupiter" className="mobile_planets_name spartan">
              jupiter
            </Link>
          </div>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/saturn" className="mobile_planets_name spartan">
              saturn
            </Link>
          </div>
          ...
          <div className="mobile_box">
            ...
            <Link onClick={props.activeButton} to="/uranus" className="mobile_planets_name spartan">
              uranus
            </Link>
          </div>
          <div className="mobile_box">
            <div className="circle neptune "></div>
            <Link onClick={props.activeButton} to="/neptune" className="mobile_planets_name spartan">
              neptune
            </Link>
          </div>
        </div>
